...
import { TemplateTypeManageComponent } from "./components/template-type-manage/template-type-manage.component";
...
@NgModule({
  declarations: [TemplateTypeListComponent, TemplateTypeManageComponent],
  imports: [
    CommonModule,
