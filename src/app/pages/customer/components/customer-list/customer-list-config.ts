...
const tableColumns: TableColumns<CustomerResponse>[] = [
  ...
  },
  {
    ...
    cssLabel: ["font-bold", "text-sm"],
    property: "creditInterestRate",
    cssProperty: ["font-semibold", "text-sm", "text-left"],
    type: "number",
    sticky: false,
    sort: true,
    sortProperty: "creditInterestRate",
    visible: true,
    download: true,
  },
  {
...
export const componentSettings = {
  icCustomer: IconsService.prototype.getIcon("icCustomer"),
  searchOptions,
  menuItems,
  tableColumns,
  initialSort: "Id",
