...
const tableColumns: TableColumns<CreditTypeResponse>[] = [
  {
    label: "NOMBRE",
...
export const componentSettings = {
  icCreditType: IconsService.prototype.getIcon("icCreditType"),
  searchOptions,
  menuItems,
  tableColumns,
  initialSort: "Id",
  ...
  resetFilters,
  getInputs,
  filename: "listado-de-tipos-de-credito",
};
