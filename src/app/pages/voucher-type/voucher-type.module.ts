...
import { VoucherTypeManageComponent } from "./components/voucher-type-manage/voucher-type-manage.component";
...
@NgModule({
  declarations: [VoucherTypeListComponent, VoucherTypeManageComponent],
  imports: [
    CommonModule,
