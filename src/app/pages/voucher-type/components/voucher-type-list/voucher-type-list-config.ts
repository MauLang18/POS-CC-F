...
const tableColumns: TableColumns<VoucherTypeResponse>[] = [
  {
    label: "NOMBRE",
...
export const componentSettings = {
  icVoucherType: IconsService.prototype.getIcon("icVoucherType"),
  searchOptions,
  menuItems,
  tableColumns,
  initialSort: "Id",
  ...
  resetFilters,
  getInputs,
  filename: "listado-de-tipos-de-vouchero",
};
