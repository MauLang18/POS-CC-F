...
const tableColumns: TableColumns<EmailTemplateResponse>[] = [
  {
    label: "ASUNTO",
...
export const componentSettings = {
  icEmailTemplate: IconsService.prototype.getIcon("icEmailTemplate"),
  searchOptions,
  menuItems,
  tableColumns,
  initialSort: "Id",
  ...
  resetFilters,
  getInputs,
  filename: "listado-de-plantillas-emails",
};
