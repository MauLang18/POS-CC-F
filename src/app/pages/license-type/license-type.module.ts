...
import { LicenseTypeManageComponent } from "./components/license-type-manage/license-type-manage.component";
...
@NgModule({
  declarations: [LicenseTypeListComponent, LicenseTypeManageComponent],
  imports: [
    CommonModule,
